...
OUTPUT_PATH=/home/u2139934/Warehouse/models/prune_baseline/Mixtral-8x7B-v0.1_mixtral_layerwise_pruning_r6_c4_32_20241202-1608
python3 main.py --method layerwise_pruning --r 6 --calib_set c4 --n_blocks_for_stat 32 --model_path $MODEL_PATH --output_path $OUTPUT_PATH |& tee new_results/log_mixtral_r6_c4_32_gsm8k
lm_eval --model hf \
    --model_args pretrained=$OUTPUT_PATH,dtype=bfloat16,parallelize=True \
    --tasks gsm8k --batch_size 32 |& tee new_results/result_mixtral_r6_c4_32_gsm8k
