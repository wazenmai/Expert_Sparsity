...
OUTPUT_PATH=/home/u2139934/Warehouse/models/prune_baseline/Qwen1.5-MoE-A2.7B-Chat_qwen_layerwise_pruning_r45_c4_32_20241202-1645
# 
# --num_processes=1 \
...
python3 main.py --method qwen_layerwise_pruning --r 45 --calib_set c4 --n_blocks_for_stat 32 --model_path $MODEL_PATH --output_path $OUTPUT_PATH |& tee new_results/log_qwen_r45_c4_32_gsm8k
lm_eval --model hf \
    --model_args pretrained=$OUTPUT_PATH,dtype=bfloat16,parallelize=True \
    --tasks gsm8k --batch_size 16 |& tee log_result_qwen_45


# gsm8k
# mixtral - batch_size=32, 6hr
# qwen - batch_size=16, 3hr